 ...
 */
final class Version20230524073350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT DEFAULT NULL, ADD number INT NOT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL');
